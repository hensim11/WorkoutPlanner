    ...
    public partial class InitialCreate2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favourites_Workouts_WorkoutId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutsLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkoutsLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkoutsLogs_Workouts_WorkoutId",
                        column: x => x.WorkoutId,
                        principalTable: "Workouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favourites_WorkoutId",
                table: "Favourites",
                column: "WorkoutId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkoutsLogs_UserId",
                table: "WorkoutsLogs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkoutsLogs_WorkoutId",
                table: "WorkoutsLogs",
                column: "WorkoutId");
        }
