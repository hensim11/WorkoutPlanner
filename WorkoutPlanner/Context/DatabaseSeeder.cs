        ...
        private List<Workout> GetWorkouts()
            {
                ...
                [
                    ...
                    new Workout { ExerciseName = "Squat", Reps = 12, Sets = 3, Weight = 50, RestTime = 90, ExerciseInfo = "A compound movement targeting quadriceps, glutes, and hamstrings." },
                    new Workout { ExerciseName = "Lunge", Reps = 12, Sets = 3, Weight = 20, RestTime = 60, ExerciseInfo = "Targets quadriceps, glutes, and stabilizer muscles." },
                    ...
                    new Workout { ExerciseName = "Leg Press", Reps = 12, Sets = 3, Weight = 100, RestTime = 90, ExerciseInfo = "Targets the quadriceps, hamstrings, and glutes." },
                    ...
                    new Workout { ExerciseName = "Crunch", Reps = 15, Sets = 3, Weight = 0, RestTime = 60, ExerciseInfo = "Focuses on the upper abdominal muscles." },
                    ...
                    new Workout { ExerciseName = "Lat Pulldown", Reps = 12, Sets = 3, Weight = 50, RestTime = 90, ExerciseInfo = "Works the latissimus dorsi, biceps, and middle back." },
                    new Workout { ExerciseName = "Chest Fly", Reps = 12, Sets = 3, Weight = 20, RestTime = 60, ExerciseInfo = "Isolates the chest muscles, focusing on pectoral activation." },
                    ...
                    new Workout { ExerciseName = "Leg Raise", Reps = 12, Sets = 3, Weight = 0, RestTime = 60, ExerciseInfo = "Works the lower abdominal muscles." },
